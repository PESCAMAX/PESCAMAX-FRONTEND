...
// import { Alerta, ApiService, Especie, Monitoreo, Asignar } from '../../../../features/monitoreo/services/api-form/api.service';
...
//     this.apiService.listarAsignar().subscribe({
//       next: (asignaciones: Asignar[]) => {
//         asignaciones.forEach(asignacion => {
//           this.selectedLote[asignacion.EspecieID] = asignacion.LoteID;
//         });
//       },
//       error: (error: HttpErrorResponse) => console.error('Error al cargar asignaciones:', error)
//     });
//   }
...
//       Id: 1,
//       EspecieNomb: this.especies.find(e => e.Id === especieId)?.NombreEspecie || '',
//       LoteID: loteId,
//       UserId: this.userId,
//       EspecieID: undefined
//     };

//     this.apiService.crearOActualizarAsignacion(asignar).subscribe({
//       next: (response) => {
//         console.log('Asignación creada o actualizada:', response);
//         this.alertService.showAlert('info', 'Asignación guardada', 'La selección ha sido guardada exitosamente.');
//       },
//       error: (error) => {
//         console.error('Error al guardar la asignación:', error);
//         this.alertService.showAlert('danger', 'Error', 'Hubo un error al guardar la asignación.');
//       }
//     });
//   }
