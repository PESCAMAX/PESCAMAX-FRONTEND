...
export class AuthService {
  //pescamaxbueno2-a4dafmg2czhtgyg8.centralus-01.azurewebsites.net
  private apiUrl = 'https://pescamaxbueno2-a4dafmg2czhtgyg8.centralus-01.azurewebsites.net/api/Auth';
